...
const DeleteSubcriteria = ({
  selectedSubcriteria,
  setOpenDeleteSubcriteria,
}) => {
  const close = () => {
    setOpenDeleteSubcriteria(false);
  };

  const handleDelete = async () => {
    try {
      await remove(ref(db, `subcriteria/${selectedSubcriteria.key}`));
...
export default DeleteSubcriteria;
